...
public class ClientGui {
	//Connection Connection =
			//DriverManager.getConnection("jdbc:mysql://localhost:3306/project2", "client2", "client");
	...
	private static main mDAO;
	
	public static void main(String[] args){
		InitWindow();
	}
	private static void InitWindow(){
		mJFrame = new JFrame("SQL Client Gui");
	...
	private static void InitTextFields(){
		...
		mDatabaseCB = new JComboBox(new String[]{"jdbc:mysql://localhost:3306/project2"});
	...
	private static void InitButtons(){
		...
		mConnectButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				if(!mUsernameTF.getText().isEmpty() ){
					mDBEngine = new DBEngine("jdbc:mysql://localhost:3306/project2",mUsernameTF.getText(),mPasswordTF.getText());
					...
					if(mDBEngine.getConnection() != null){
						mConnectionL.setText("jdbc:mysql://localhost:3306/project2");
		...
		mExecuteButton.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				mDAO = new main(mDBEngine.getConnection());
	...
	private static void InitPlacement(){
		...
		mSpringLayout.putConstraint(SpringLayout.EAST, mExecuteButton, -10, SpringLayout.EAST, mMainPanel);
		mSpringLayout.putConstraint(SpringLayout.SOUTH, mExecuteButton, -10, SpringLayout.VERTICAL_CENTER, mMainPanel);
		
		
		mSpringLayout.putConstraint(SpringLayout.WEST, mClearCommandButton, 0, SpringLayout.WEST, mCommandScrollPane);
